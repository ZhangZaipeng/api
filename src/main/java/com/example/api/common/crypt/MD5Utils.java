package com.example.api.common.crypt;
...
public class MD5Utils {
  ...
  public static String MD5Salf(String id, String password, String salt) throws Exception {
    try {
      ...
      if (StringUtils.isEmpty(salt) || StringUtils.isEmpty(password)) {
        throw new Exception(
            "[getPassword][salf=" + salt + "][id=" + id + "][password=" + password + "]");
      }
  ...
  public static void main(String[] args) {
    System.out.println(
        MD5("backurl=http://pay.zcaibao.com/success.html&geway_code=7&notifyurl=http://pay.zcaibao.com/pay/notify.html&number_id=616&time=2019-11-07 21:17:20&version=1.1&zcddh=11&zcdesc=充值&zcfee=100&zcip=127.0.0.1&zcname=充值7P2VVRMCB13A24TPC2WW1QRG3GCSSE1U9CTL2PXNSHHJ0Z07A2B7WBYCP33C9T7OXIENG8JLDT9854ONDZSO0QRR703GTKFORI9EDBI92OA3GSD78U9B2WZ9ORQ7LGSL"));
  }
}
